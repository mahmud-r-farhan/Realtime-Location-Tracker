...
function openProfileDialog() {
    ...
    const handleSave = () => {
        ...
        newBtn.removeEventListener('click', handleSave);
    };
...
function attachEventListeners() {
    ...
    if (fabProfileBtn) {
        fabProfileBtn.addEventListener('click', openProfileDialog);
    }
    ...
    if (mobileProfileBtn) {
        mobileProfileBtn.addEventListener('click', openProfileDialog);
    }
...
function createLayerSelector() {
    import('./map.js').then(module => {
        ...
        modal.className = 'layer-selector-modal';
